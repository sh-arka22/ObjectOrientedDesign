...
public class Game {
    ...
    void Initialize(){
        /** Creating Twp Players */
        players = new ArrayDeque<>();
        PlayingPieceX X = new PlayingPieceX();
        PlayingPieceO O = new PlayingPieceO();
        Player arka = new Player("arka", X);
        Player soumi = new Player("soumi", O);
    ...
    public String startGame(){
        ...
        while(noWinner){
            ...
            boolean winner = isThereWinner(inputRow, inputColumn, playerTurn.getPlayingPiece().piece);
            if(winner) {
